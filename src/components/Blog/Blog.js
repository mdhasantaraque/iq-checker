      ...
      <div className="container max-w-4xl px-10 py-6 mx-auto rounded-lg shadow-sm dark:bg-gray-900">
        <div className="mt-3">
          ...
          <p className="mt-2">
            ...
            Router Package. It provides the synchronous URL on the browser with
      ...
      <div className="container max-w-4xl px-10 py-6 mx-auto my-5 rounded-lg shadow-sm dark:bg-gray-900">
        <div className="mt-3">
          ...
          <p className="mt-2">
            ...
            your components. One of the most common use cases of the hook useRef
            in React is to reference a DOM element. These hooks make it easier
            to encapsulate stateful behavior and side effects in your functional
            components in order to increase readability and to use less code.
            <br />
            ...
            <br />
            It is very similar to useState , but it doesn’t cause a component to
            re-render when changed. To make things more clear.
          </p>
        </div>
      </div>
    </div>
